...
float **w5,**w55,**w555;// 5nd layer wts
...
// x[][]=>input data, d[][]=>desired output data
  ...
  cout<<"TrainNet1: IP:"<<NumIPs<<" H1:"<<NumHN1<<" OP:"<<NumOPs<<endl;
...
//x[][]=>input data, d[][]=>desired output data
  ...
  float *y  = new float[NumOPs]; // O/P of Net
  float *ad1= new float[NumHN1]; // HN1 back prop errors 1
  float *ad2= new float[NumHN2]; // HN1 back prop errors 2
  float *ad3= new float[NumOPs]; // O/P back prop errors 3
  float PatErr,MinErr,AveErr,MaxErr;  // Pattern errors
  int p,i,j;     // for loops indexes
  long ItCnt=0;  // Iteration counter
  long NumErr=0; // Error counter (added for spiral problem)
...
//x[][]=>input data, d[][]=>desired output data
  ...
  long NumErr=0; // Error counter (added for spiral problem)
  int *shuffleArray = generateOrdering(NumPats);
  cout<<"TrainNet3: IP:"<<NumIPs<<" H1:"<<NumHN1<< " H2:" <<NumHN2<< " H3:" <<NumHN3 << "OP:"<<NumOPs<<endl;
